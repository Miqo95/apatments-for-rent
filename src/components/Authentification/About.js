...
function About() {
  ...
  return (
    <div className={classes.aboutPage}>
      ...
      <p>
        In 2015, the "Grand buffet" opened on the second floor of the branch at
        32 Tumanyan street, where salads, soups and other hot snacks are served.
      </p>
      <p>
        Staying true to the expansion strategy, in 2018, the fast food chain
        Tumanyan Shawarma opened another branch in the Davtashen administrative
        district.
      </p>
